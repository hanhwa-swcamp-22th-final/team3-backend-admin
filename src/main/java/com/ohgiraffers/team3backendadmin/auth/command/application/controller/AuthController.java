package com.ohgiraffers.team3backendadmin.auth.command.application.controller;
...
import com.ohgiraffers.team3backendadmin.auth.command.application.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Void>> logout(
        ...
        if (refreshToken != null) {
            this.authService.logout(refreshToken); // DB refresh token 삭제
        }
