...
public class EquipmentManageQueryController {
    ...
    /**
     * 생산 라인 상세 정보를 조회한다.
     * @param factoryLineId 조회할 생산 라인 식별자
     * @return 생산 라인 상세 응답
     */
    ...
    /**
     * 공정 상세 정보를 조회한다.
     * @param equipmentProcessId 조회할 공정 식별자
     * @return 공정 상세 응답
     */
    ...
    /**
     * 환경 기준 상세 정보를 조회한다.
     * @param environmentStandardId 조회할 환경 기준 식별자
     * @return 환경 기준 상세 응답
     */
    ...
    /**
     * 환경 이벤트 상세 정보를 조회한다.
     * @param environmentEventId 조회할 환경 이벤트 식별자
     * @return 환경 이벤트 상세 응답
     */
