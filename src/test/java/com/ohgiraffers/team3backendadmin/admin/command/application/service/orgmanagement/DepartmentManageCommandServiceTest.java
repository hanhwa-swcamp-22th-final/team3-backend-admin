...
class DepartmentManageCommandServiceTest {

    @InjectMocks
    private DepartmentManageCommandService departmentManageCommandService;
    ...
    class InsertDepartment {
        ...
        void insertDepartmentSavesVerifiedDepartment() {
            ...
            // when
            departmentManageCommandService.insertDepartment(request, "EMP-0001");
