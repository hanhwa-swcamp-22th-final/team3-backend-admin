...
import com.ohgiraffers.team3backendadmin.auth.command.application.dto.request.LoginRequest;
import com.ohgiraffers.team3backendadmin.auth.command.application.dto.response.TokenResponse;
import com.ohgiraffers.team3backendadmin.auth.command.domain.aggregate.*;
import com.ohgiraffers.team3backendadmin.auth.command.domain.repository.AuthRepository;
import com.ohgiraffers.team3backendadmin.auth.command.domain.repository.DepartmentRepository;
...
class AuthServiceTest {
    ...
    class RefreshTokenTest {
        ...
        void refreshTokenSuccess() {
            ...
            com.ohgiraffers.team3backendadmin.auth.command.domain.aggregate.RefreshToken storedToken =
                    com.ohgiraffers.team3backendadmin.auth.command.domain.aggregate.RefreshToken.builder()
                            .employeeCode("EMP-0001")
            ...
            verify(jpaAuthRepository).save(any(com.ohgiraffers.team3backendadmin.auth.command.domain.aggregate.RefreshToken.class));
        }
